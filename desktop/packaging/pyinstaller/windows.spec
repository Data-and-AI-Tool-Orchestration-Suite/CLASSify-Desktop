...
"""PyInstaller spec for CLASSify Desktop on Windows.

Produces a --onedir bundle with three entry points:
  - CLASSify.exe       (desktop shell)
  - classify-jobworker.exe (job subprocess)
  - classify-api.exe   (headless API server)
"""
